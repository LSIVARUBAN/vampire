...
namespace vout{
   ...
   int cubic_geofencing_material_id = 0; // use material 0 magnetization by default
   double uniaxial_geofencing_threshold = 0.95; // default dot product threshold
   int uniaxial_geofencing_material_id = 0; // use material 0 magnetization by default
