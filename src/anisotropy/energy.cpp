...
namespace anisotropy{
   ...
   double single_spin_energy(const int atom, const int mat, const double sx, const double sy, const double sz, const double temperature){
      ...
      if(internal::enable_rotational_6_3_order)	      	energy += internal::sixth_order_theta_third_order_phi_energy(atom, mat, sx, sy, sz);
      if(internal::enable_rotational_6_3_order_odd)      energy += internal::sixth_order_theta_third_order_phi_odd_energy(atom, mat, sx, sy, sz);
      ...
      if(internal::enable_rotational_6_5_order)      		energy += internal::sixth_order_theta_fifth_order_phi_energy(atom, mat, sx, sy, sz);
      ...
      if(internal::enable_neel_fourth_order_anisotropy)  energy += internal::neel_energy_fourth(atom, mat, sx, sy, sz);
      else if(internal::enable_neel_anisotropy)          energy += internal::neel_energy(atom, mat, sx, sy, sz);
