...
Defines the fourth order N\'eel pair anisotropy coefficient $Q_{ij}$. This term
is only used when \textit{anisotropy:enable_fourth_order_neel_anisotropy} is
enabled. Both \textit{material:neel-anisotropy-constant} and
\textit{material:neel-fourth-order-anisotropy-constant} must be specified.
