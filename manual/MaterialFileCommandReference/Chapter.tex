...
{\zicf material:4-2-order-anisotropy-constant = float 0.0\newline J/atom}\phantomsection\addcontentsline{toc}{subsection}{material:4-2-order-anisotropy-constant} Has the same meaning.
...
{\zicf material:4-4-order-anisotropy-constant = float 0.0\newline J/atom}\phantomsection\addcontentsline{toc}{subsection}{material:4-4-order-anisotropy-constant} Has the same meaning.
...
{\zicf material:sixth-order-theta-second-order-phi-anisotropy-constant = float 0.0\newline J/atom}\phantomsection\addcontentsline{toc}{subsection}{material:sixth-order-theta-second-order-phi-anisotropy-constant} Sets the sixth order $\theta$ second order $\phi$ rotational anisotropy constant for single ion anisotropy in the tesseral harmonic formalism.
...
{\zicf material:exchange-J0=float [ 0-1 : default 0.904 !eV]}\phantomsection\addcontentsline{toc}{subsection}{material:exchange-J0}
Sets the $J_0$ energy prefactor used by the cubic spin-lattice exchange function.

{\zicf material:exchange-K0=float}\phantomsection\addcontentsline{toc}{subsection}{material:exchange-K0}
Sets the $K_0$ energy prefactor used by the cubic spin-lattice exchange function. It is required for every material when \textit{spin-lattice:spin-hamiltonian=biquadratic}.

{\zicf material:bethe-slater-alpha-j=float}\phantomsection\addcontentsline{toc}{subsection}{material:bethe-slater-alpha-j}
Sets the energy coefficient $\alpha_J$ of the spin-lattice Bethe--Slater bilinear exchange curve, $J(r)=4\alpha_J x(1-\gamma_J x)\exp(-x)$ with $x=(r/\delta_J)^2$.

{\zicf material:bethe-slater-gamma-j=float}\phantomsection\addcontentsline{toc}{subsection}{material:bethe-slater-gamma-j}
Sets the dimensionless coefficient $\gamma_J$.

{\zicf material:bethe-slater-delta-j=float}\phantomsection\addcontentsline{toc}{subsection}{material:bethe-slater-delta-j}
Sets the positive coefficient $\delta_J$. The default unit is Angstrom.

{\zicf material:bethe-slater-alpha-k=float}\phantomsection\addcontentsline{toc}{subsection}{material:bethe-slater-alpha-k}
Sets the energy coefficient $\alpha_K$ of the biquadratic Bethe--Slater curve. This and the other $K$ parameters are required only for \textit{spin-lattice:exchange-function=bethe-slater} together with \textit{spin-lattice:spin-hamiltonian=biquadratic}.

{\zicf material:bethe-slater-gamma-k=float}\phantomsection\addcontentsline{toc}{subsection}{material:bethe-slater-gamma-k}
Sets the dimensionless coefficient $\gamma_K$.

{\zicf material:bethe-slater-delta-k=float}\phantomsection\addcontentsline{toc}{subsection}{material:bethe-slater-delta-k}
Sets the positive length coefficient $\delta_K$. The default unit is Angstrom.
...
{\zicf material:coupling-C0=float [0-1; default 0.5]}\phantomsection\addcontentsline{toc}{subsection}{material:coupling-C0}
Sets the dimensionless coupling coefficient $C$ used by \textit{spin-lattice:coupling=pseudodipolar}.

{\zicf material:neel-C-l=float [default 1.0e-2]}\phantomsection\addcontentsline{toc}{subsection}{material:neel-C-l}
Sets the dimensionless $C_l$ coefficient in $l(r)=C_lJ_0(1\,\text{\AA}/r)^4$ for the inverse-fourth full N\'eel coupling.

{\zicf material:neel-C-q=float [default -1.0e-4]}\phantomsection\addcontentsline{toc}{subsection}{material:neel-C-q}
Sets the dimensionless $C_q$ coefficient in $q(r)=C_qJ_0(1\,\text{\AA}/r)^4$ for the inverse-fourth full N\'eel coupling.

{\zicf material:neel-alpha-l=float}\phantomsection\addcontentsline{toc}{subsection}{material:neel-alpha-l}
Sets the energy coefficient $\alpha_l$ of the N\'eel Bethe--Slater $l(r)$ curve. 

{\zicf material:neel-gamma-l=float}\phantomsection\addcontentsline{toc}{subsection}{material:neel-gamma-l}
Sets the dimensionless $\gamma_l$ coefficient. 

{\zicf material:neel-delta-l=float}\phantomsection\addcontentsline{toc}{subsection}{material:neel-delta-l}
Sets the $\delta_l$ length. 

{\zicf material:neel-alpha-q=float}\phantomsection\addcontentsline{toc}{subsection}{material:neel-alpha-q}
Sets the energy coefficient $\alpha_q$ of the N\'eel Bethe--Slater $q(r)$ curve. 

{\zicf material:neel-gamma-q=float}\phantomsection\addcontentsline{toc}{subsection}{material:neel-gamma-q}
Sets the dimensionless $\gamma_q$ coefficient.

{\zicf material:neel-delta-q=float}\phantomsection\addcontentsline{toc}{subsection}{material:neel-delta-q}
Sets the $\delta_q$ length. 
