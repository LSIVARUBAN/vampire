...
namespace program
{
	...
	extern double effective_damping_angle; // angle to rotate spins from z-axis
	extern std::vector<double> effective_damping_rotation_axis; // axis to rotate spins around
