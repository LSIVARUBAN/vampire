   ...
   namespace internal{
      ...
      class mp_t
      {
         ...
         public:
            ...
            std::vector< double > qij; // fourth order Neel anisotropy pair constant (quartic term) in collinear spin model
      ...
      extern bool enable_neel_fourth_order_anisotropy; // Flag to select fourth order (collinear spin) Neel anisotropy model
